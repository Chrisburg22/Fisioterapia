...
import { $ as $$Layout } from './404_1rQ4mQph.mjs';
...
</h3> <div class="fw-full mx-auto md:max-w-6xl sm:px-8 flex-column justify-center items-center"> <!-- Basic Pricing --> <div class="relative flex flex-col items-center sm:flex-row gap-8"> ${renderComponent($$result, "Paquetes", $$Paquetes, { "title": "B\xE1sico", "content": ["5 sesiones"], "description": ["Paquete de 5 sesiones de terapia f\xEDsica."], "price": 1700, "message": "Hola, me gustar\xEDa saber m\xE1s acerca de tu paquete BASICO de 5 sesiones" })} ${renderComponent($$result, "Paquetes", $$Paquetes, { "title": "Pro", "content": ["10 sesiones"], "description": ["Paquete de 10 sesiones de terapia f\xEDsica."], "price": 3e3, "message": "Hola, me gustar\xEDa saber m\xE1s acerca de tu paquete PRO de 10 sesiones" })} </div> <div class="relative flex flex-col items-center sm:flex-row gap-8"> ${renderComponent($$result, "Paquetes", $$Paquetes, { "title": "Basic a domicilio", "content": ["1 sesi\xF3n", "Servicio a domicilio"], "description": [
    "Paquete de 1 sesiones de terapia f\xEDsica.",
    "El precio puede variar segun la distanc\xEDa"
  ], "price": 500, "message": "Hola, me gustar\xEDa saber m\xE1s acerca de tu paquete BASIC a domicilio de 1 sesi\xF3n" })} ${renderComponent($$result, "Paquetes", $$Paquetes, { "title": "Pro a domicilio", "content": ["10 sesiones", "Servicio a domicilio"], "description": [
    "Paquete de 10 sesiones de terapia f\xEDsica.",
    "El precio puede variar segun la distanc\xEDa"
  ], "price": 4500, "message": "Hola, me gustar\xEDa saber m\xE1s acerca de tu paquete PRO a domicilio de 10 sesiones" })} </div> </div> </div> </div>`;
...
const image1 = new Proxy({"src":"/_astro/1.DcJ30Ert.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/1.jpeg";
							}
...
const image2 = new Proxy({"src":"/_astro/2.CUvl4ltI.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/2.jpeg";
							}
...
const image3 = new Proxy({"src":"/_astro/3.p0I6ndUg.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/3.jpeg";
							}
...
const image4 = new Proxy({"src":"/_astro/4.BlibFAnP.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/4.jpeg";
							}
...
const image5 = new Proxy({"src":"/_astro/5.xfVj3u58.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/5.jpeg";
							}
...
const image6 = new Proxy({"src":"/_astro/6.DOR-p_Yh.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/6.jpeg";
							}
...
const image7 = new Proxy({"src":"/_astro/7.D2CONUbD.jpeg","width":828,"height":1472,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/7.jpeg";
							}
...
const image8 = new Proxy({"src":"/_astro/8.57e26S_R.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/8.jpeg";
							}
...
const image9 = new Proxy({"src":"/_astro/9.rGz8IWRf.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/9.jpeg";
							}
...
const image10 = new Proxy({"src":"/_astro/10.CNTaaf6z.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/10.jpeg";
							}
...
const image11 = new Proxy({"src":"/_astro/11.BjSCQLZZ.jpeg","width":1200,"height":1600,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/11.jpeg";
							}
...
const image12 = new Proxy({"src":"/_astro/12.DmHLSFhY.jpg","width":2976,"height":1984,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/12.jpg";
							}
...
const image13 = new Proxy({"src":"/_astro/13.HFyRACcn.jpg","width":2976,"height":1984,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/13.jpg";
							}
...
const image14 = new Proxy({"src":"/_astro/14.ZirFRVoY.jpg","width":1984,"height":2976,"format":"jpg","orientation":8}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/14.jpg";
							}
...
const image15 = new Proxy({"src":"/_astro/15.B3yV7MVj.jpg","width":1984,"height":2976,"format":"jpg","orientation":8}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/15.jpg";
							}
...
const image16 = new Proxy({"src":"/_astro/16.eH-_IGAT.jpg","width":2976,"height":1984,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/16.jpg";
							}
...
const image17 = new Proxy({"src":"/_astro/17.CyONXZpq.jpg","width":2976,"height":1984,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/17.jpg";
							}
...
const image18 = new Proxy({"src":"/_astro/18.BotCM7op.jpg","width":1984,"height":2976,"format":"jpg","orientation":8}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/18.jpg";
							}
...
const image19 = new Proxy({"src":"/_astro/19.CziRWNvt.jpg","width":2976,"height":1984,"format":"jpg","orientation":1}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/christianalejandroramosperez/Documents/Proyects/PhysicalRehabilitation/src/images/consultorio/19.jpg";
							}
...
Tu plan de tratamiento se ajustará perfectamente a tus necesidades,
    ...
    >
      <span
        class="bg-slate-500 inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none"
      >
        <svg
